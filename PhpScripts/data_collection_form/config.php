<?php
	...
	// Create tables
	// create table `client_data` (`rollno` int(15) NOT NULL, `image` longtext NOT NULL, `signature` longtext NOT NULL, `document` longtext, `created` datetime NOT NULL, PRIMARY KEY (`rollno`) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
?>
